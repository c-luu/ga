...
A directed graph, $G = (V, E)$, with capacities $c_e > 0, \, \forall e \in E$. It also has source vertex $s \in V$ and sink vertex $t \in V$ and capacity function $c:E \to \mathbb{N}$.
\end{definition}
...
Represents the flow along an edge, $e \in E$ satisfying properties \ref{prop:capacity} and \ref{prop:conservation}.
\end{definition}
