...
This problem takes a set of $m$ clauses, each a dis-junction of literals, an integer $k$. Based on this, it needs to find a satisfying assignment in which \textit{at most} $k$ variables are true, if such an assignment exists.
